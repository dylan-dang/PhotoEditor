...
public class GlobalCoordinatePositionUpdateSample extends LinearOpMode {
    ...
    String LeftEncoderName = "r_b_drive", RightEncoderName = "intake_l", horizontalEncoderName = "l_b_drive";

    @Override
    public void runOpMode() throws InterruptedException {

        //Assign the hardware map to the odometry wheels
        verticalLeft = hardwareMap.dcMotor.get(LeftEncoderName);
        verticalRight = hardwareMap.dcMotor.get(RightEncoderName);
